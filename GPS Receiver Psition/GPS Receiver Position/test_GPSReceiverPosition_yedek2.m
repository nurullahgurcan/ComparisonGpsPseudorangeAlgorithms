...
[obs_raw,rec_xyz_actual] = read_rinex_obs('guam0040.23o', nepoch);
% [obs_raw,rec_xyz_actual] = read_rinex_obs('amc40030.23o', nepoch);
rec_xyz = zeros(3,1);
...
[ephemeris_raw, matched_epochs] = read_rinex_nav('GUAM00GUM_R_20230040000_01D_GN.rnx', epochs);
% [ephemeris_raw, matched_epochs] = read_rinex_nav('amc40030.23n', epochs);
...
for ii=1:length(TimeSpan)    
    ...
    [pos_weighted_ls(ii,1:4)] = weightedLeastSquarePos(satpos, obs_pseudo, weight);
...
plot_err(rec_xyz_actual, matched_epochs, pos_original_code, ...
    pos_least_squares, pos_multilateration, pos_weighted_ls);
